{{-- skills-categories.blade.php --}}
<section class="categories-section">
    <div class="categories-container">
        <h2 class="categories-title">Choose Different <span>Skills</span></h2>
        ...
        <div class="more-categories">
            <a href="{{ route('skills.all') }}" class="more-categories-btn">More Categories</a>
        </div>
    </div>
</section>
{{-- Include the original CSS styles --}}
<style>
.categories-section {
    padding: 4rem 2rem;

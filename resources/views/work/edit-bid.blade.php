...
<div class="bid-container">
    ...
    <div class="bid-form-container">
        <h2 class="bid-form-title">Update Your Bid</h2>
        ...
        <form action="{{ route('work.bid.update', ['work' => $work, 'bid' => $bid]) }}" method="POST">
            ...
            <div class="form-group">
                <label for="bid_amount" class="form-label">New Bid Amount</label>
                <input type="number" 
                       id="bid_amount" 
                       name="bid_amount" 
                       class="form-input" 
            ...
            <button type="submit" class="submit-bid-btn">Update Bid</button>
        </form>
    </div>
</div>
@endsection 